...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/06/12 22:59:47 by jodufour          #+#    #+#             */
/*   Updated: 2023/06/13 15:23:49 by jodufour         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * 			and insert it at the beginning of a direction list.
 * 
	...
	t_vector_2d const *const vector)
{
	...
	return (direction_list_push_front(list, node));
}
